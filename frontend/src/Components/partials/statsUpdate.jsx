            ...
            <div className="appFrame">
                <form className="row align-items-center itemContainer">
                    ...
                    <div className="col-12-sm mx-auto item">
                        ...
                        <input type="text" className="form-control" name="dishName" value={stats.dishName} placeholder="Rätts namn" onChange={handleChange} />
                    </div>
                    <div className="col-12-sm mx-auto item" >
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                        <input type="text" className="form-control" name="guestAmount" value={stats.guestAmount} placeholder="Ätande matsal" onChange={handleChange} />
                    </div>
                    <div className="col-12-sm mx-auto item">
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                    ...
                    <div className="col-12 mx-auto item">
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                        <input type="text" className="form-control" name="purchasedMainIngredient" value={stats.purchasedMainIngredient} placeholder="Inköpt huvud varor" onChange={handleChange} />
                    </div>
                    <div className="col-12 mx-auto item">
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                        <input type="text" className="form-control" name="usedMainIngredient" value={stats.usedMainIngredient} placeholder="Använd huvud varor" onChange={handleChange} />
                    </div>
                    <div className="col-12 mx-auto item">
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                    ...
                    <div className="col-12 mx-auto item">
                        ...
                        <div className="input-group">
                            <input type="text" className="form-control" name="stewSoupLeft" value={stats.stewSoupLeft} placeholder="Gryta/Soppa över" onChange={handleChange} />
                            <div className="input-group-text">
                    ...
                    <div className="col-12-sm mx-auto item">
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                        <input type="text" className="form-control" name="sideIngredient" value={stats.sideIngredient} placeholder="Tillbehör" onChange={handleChange} />
                    </div>
                    <div className="col-12 mx-auto item">
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                        <input type="text" className="form-control" name="purchasedSide" value={stats.purchasedSide} placeholder="Inköpt tillbehör varor" onChange={handleChange} />
                    </div>
                    <div className="col-12 mx-auto item">
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                        <input type="text" className="form-control" name="usedSideIngredient" value={stats.usedSideIngredient} placeholder="Använd tillbehör varor" onChange={handleChange} />
                    </div>
                    <div className="col-12 mx-auto item">
                        <label className="visually-hidden" htmlFor="autoSizingInput"></label>
                    ...
                    <div className="input-group col-12 mx-auto item" style={{ margin: "10px auto", maxWidth: "350px" }}>
                        ...
                        <textarea id="comment" className="form-control" aria-label="With textarea" name='comment' value={stats.comment}
                            placeholder="Till lägg beskrivning" onChange={handleChange}></textarea>
                    </div>
